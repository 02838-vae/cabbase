...
# ====================================================
# 🧩 PARSER 6: PHỤ LỤC 4 - LUẬT VÀ QUI TRÌNH (PASSAGE-BASED) - ĐÃ SỬA LỖI PARAGRAPH 2
# ====================================================
# ... (parse_pl3_passage_bank remains unchanged)
...
if bank_choice != "----":
    ...
    if "Kỹ thuật" in bank_choice:
        ...
        if st.session_state.doc_selected == "Phụ lục 1 : Ngữ pháp chung":
            ...
            source = "PL4.docx" # File PL4.docx (Dùng parse_pl3_passage_bank)
    ...
    if source:
        if "Kỹ thuật" in bank_choice:
            ...
            if source == "PL1.docx":
                ...
                questions = parse_pl4_passage_bank(source) # <-- Dùng parser đã sửa cho PL3
