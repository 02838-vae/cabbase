...
<body>
    ...
    <script>
        ...
        function togglePlayPause(forcePlay = false) {{
            // Kiểm tra trạng thái hiển thị của đối tượng .stApp cấp cao nhất
            const isFinished = window.parent.document.querySelector('.stApp').classList.contains('video-finished');
