...
# === CSS CỰC KỲ ĐƠN GIẢN ĐỂ FIT VÀ CENTER ===
st.markdown(f"""
<style>
/* 1. Reset và Fullscreen Cơ bản */
html, body {{ 
    margin:0; 
    padding:0; 
    height:100%; 
...
/* 2. Loại bỏ UI và Padding của Streamlit */
...
/* 3. CSS CHO VIDEO CONTAINER (Sử dụng Flexbox để Center) */
.video-container {{
    position: fixed; inset:0; width:100vw; height:100vh;
    justify-content:center; align-items:center;
    background:black; z-index:9999;
    {video_display_style} 
    flex-direction: column; /* Quan trọng cho việc center */
}}

/* 4. TĂNG CƯỜNG SỨC MẠNH CỦA CONTAIN */
.video-bg {{ 
    /* Đảm bảo video không vượt quá kích thước màn hình */
    max-width: 100%; 
    max-height: 100%;
    /* !!! Dùng contain để thấy hết hình. */
    object-fit:contain; 
}}
...
.stApp {{
    ...
    /* !!! DÙNG CONTAIN ĐỂ THẤY HẾT HÌNH BACKGROUND */
