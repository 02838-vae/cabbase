...
if 'intro_completed' in st.query_params and st.query_params['intro_completed'] == 'true':
    st.session_state.intro_done = True
    
    # Thay thế st.experimental_set_query_params(intro_completed=None)
    # Bằng cách sử dụng dict-like assignment cho st.query_params
