...
# ========== MÀN HÌNH INTRO (ĐÃ THÊM FADE-OUT) ==========
def intro_screen(is_mobile=False):
    ...
    <body>
        ...
        const blackOverlay = document.getElementById('black-overlay'); // Lấy thẻ overlay
        let finished = false;
        ...
        function startTransition() {{
            ...
            blackOverlay.style.pointerEvents = 'auto'; // Kích hoạt chặn tương tác

            // 2. Kích hoạt CHUYỂN TRANG sau khi fade-out hoàn tất
            setTimeout(() => {{
...
# =========================================================================
# ========== LUỒNG CHÍNH (ĐÃ BỎ time.sleep, DÙNG FADE TRONG JS) ==========
# =========================================================================
...
if not st.session_state.intro_done:
    ...
    if st.query_params.get('intro_completed') == '1':
        ...
        # Đặt cờ hoàn thành và rerender tức thời
