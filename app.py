...
if not st.session_state.show_main:
    if os.path.exists(video_file):
        ...
        <div class="video-container" id="videoDiv">
        ...
        vid.onended = () => {{
            ...
            videoDiv.style.transition = "opacity 1.5s ease-out";
...
try:
    if os.path.exists("background.mp3"):
        with open("background.mp3","rb") as f:
            ...
            st.markdown(f"""
            <div style='position:fixed; top:10px; left:10px; z-index:1000; width:200px;'>
